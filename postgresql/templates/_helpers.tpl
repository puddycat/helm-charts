...
{{- end }}
  [ -f /opt/postgresql/tmp/.initialized ] || [ -f /bitnami/postgresql/.initialized ]
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/postgresql/certs/tls.crt" -}}
{{- else -}}
    {{- required "Certificate filename is required when TLS in enabled" .Values.tls.certFilename | printf "/opt/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/postgresql/certs/tls.key" -}}
{{- else -}}
{{- required "Certificate Key filename is required when TLS in enabled" .Values.tls.certKeyFilename | printf "/opt/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated -}}
    {{- printf "/opt/postgresql/certs/ca.crt" -}}
{{- else -}}
    {{- printf "/opt/postgresql/certs/%s" .Values.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
...
{{- printf "/opt/postgresql/certs/%s" .Values.tls.crlFilename -}}
{{- end -}}
{{- end -}}
